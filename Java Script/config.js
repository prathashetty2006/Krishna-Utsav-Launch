...
export const CONFIG = {
  ...
  // Little Krishna Voice Greeting Settings (Authentic Kannada Little Krishna Character Voice)
  KRISHNA_VOICE: {
    ENABLED: true,
    ...
    AUDIO_CLIP_PATH: "../Image and Audio/audio/little_krishna_welcome_kannada.mp3"
  }
};
